...
const user =session?.user
 ...
 const navLinks = (
  <>
    <li>
      <Link
        href="/"
        className={`hover:text-green-900 font-semibold transition-colors ${
          path === "/" ? "text-green-900 border-b-2 border-green-900" : "text-black"
        }`}
      >
        Home
      </Link>
    ...
    <li>
      <Link
        href="/animals"
        className={`hover:text-green-900 font-semibold transition-colors ${
          path === "/animals" ? "text-green-900 border-b-2 border-green-900" : "text-black"
        }`}
      >
        All Animals
      </Link>
 ...
 <div className="dropdown lg:hidden">
  ...
  <ul
    tabIndex={0}
    className="menu menu-sm dropdown-content bg-base-100 rounded-box z-50 mt-3 w-52 p-2 shadow-2xl gap-2 text-black"
  >
    {navLinks}
  </ul>
</div>
...
<button 
  ...
  className="py-2 px-3 sm:px-5 rounded-full bg-green-900 text-xs sm:text-sm font-bold text-white hover:bg-green-700 transition-all duration-300 shadow-sm cursor-pointer"
  >
    Logout
</button>
